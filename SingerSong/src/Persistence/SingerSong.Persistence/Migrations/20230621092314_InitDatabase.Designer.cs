...
namespace SingerSong.Persistence.Migrations
{
    ...
    [Migration("20230621092314_InitDatabase")]
            ...
            modelBuilder.Entity("SingerSong.Domain.Entities.Album", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AlbumName = "Load",
                            CreatedDate = new DateTime(2023, 6, 21, 12, 23, 13, 955, DateTimeKind.Local).AddTicks(7275),
                            IsActive = false,
            ...
            modelBuilder.Entity("SingerSong.Domain.Entities.Singer", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedDate = new DateTime(2023, 6, 21, 12, 23, 13, 955, DateTimeKind.Local).AddTicks(6182),
                            IsActive = false,
                            Location = "USA",
                            MusicStyle = 16,
